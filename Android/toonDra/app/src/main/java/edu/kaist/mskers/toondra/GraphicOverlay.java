 ...
 *
 * <p>Associated {@link Graphic} items should use the following methods to convert to
 * view coordinates for the graphics that are drawn:
 * <ol>
...
public class GraphicOverlay extends View {
  ...
  public abstract static class Graphic {
     ...
     * system.
     */
    public float translateX(float xcoord) {
      if (overlay.facing == CameraSource.CAMERA_FACING_FRONT) {
        return overlay.getWidth() - scaleX(xcoord);
      } else {
        return scaleX(xcoord);
      }
    }
     ...
     * system.
     */
    public float translateY(float ycoord) {
      return scaleY(ycoord);
    }
